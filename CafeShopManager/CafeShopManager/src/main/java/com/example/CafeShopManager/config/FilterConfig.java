package com.example.CafeShopManager.config;

import org.springframework.boot.web.servlet.FilterRegistrationBean;
import org.springframework.context.annotation.Bean;
import org.springframework.stereotype.Component;

import com.example.CafeShopManager.filter.JwtFilter;
...
public class FilterConfig {
	...
	public FilterRegistrationBean<JwtFilter> jwtFilter(JwtUtil jwtUtil) {
		...
		registrationBean.addUrlPatterns("/menu/*", "/report/*", "/inventory/*", "/employee/*", "/history/*", "/setting/*");
